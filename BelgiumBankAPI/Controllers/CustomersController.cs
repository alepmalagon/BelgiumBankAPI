...
namespace BelgiumBankAPI.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,MiddleName,Surname")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,MiddleName,Surname")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
